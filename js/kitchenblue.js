...
function formatSearchResults(jsonResults) {
  ...
  //var siteCount = 0;
    ...
    $("#search-results-heading").text("Results");
    var formatedText = "";
    ...
    jsonObject.Countries.forEach(
      function(item, index) {
       ...
       formatedText += "<div class='dish-ingredients-div'><h4><b>TotalConfirmed:</b> " + item.TotalConfirmed + "</h4></div>";
       formatedText += "<div class='dish-ingredients-div'><h4><b>NewDeaths:</b> " + item.NewDeaths + "</h4></div>";
       formatedText += "<div class='dish-ingredients-div'><h4><b>NewConfirmed:</b> " + item.NewConfirmed + "</h4></div>";
       formatedText += "<div class='dish-ingredients-div'><h4><b>NewRecovered:</b> " + item.NewRecovered  + "</h4></div>";
       flag=1;
        return;
      }
    }
